...
let universities = graduates.map(function (items) {
...
let contactInfo = graduates.map(function (items) {
...
let lowCaseAnimalNames = zooAnimals.map(function (items) {
